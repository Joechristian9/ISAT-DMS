                                ...
                                <div className="bg-white rounded-xl shadow-lg p-6 border-2 border-gray-200">
                                    <div className="flex items-center justify-between mb-6">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <Button
                                                onClick={() => {
                                                    if (confirm('This will add all default objectives. Continue?')) {
                                                        router.post(route('admin.ipcrf.objectives.add-all'), {
                                                            onError: (errors) => {
                                                                console.error('Error adding all objectives:', errors);
                                                            }
                                                        });
                                                    }
                                                }}
                                    ...
                                    {objectives && objectives.length > 0 ? (
                                        <div className="space-y-3">
                                            {objectives.map((objective, index) => (
                                                <div key={objective.id} className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-200">
                                                    <div className="flex items-start justify-between">
                                                        <div className="flex-1">
                                                            <div className="flex items-center gap-2 mb-2">
                                                                <span className="text-sm font-semibold text-blue-600">{objective.code}</span>
                                                            ...
                                                            {objective.kra && (
                                                                <p className="text-xs text-gray-500">KRA: {objective.kra.name}</p>
                                                            )}
                                                        </div>
                                        ...
                                        <div className="text-center py-8">
                                            ...
                                            <p className="text-gray-500 text-sm mb-4">No objectives found</p>
                                            <Button
                                                onClick={openAddObjectiveModal}
                                                className="bg-green-600 hover:bg-green-700"
                                                size="sm"
