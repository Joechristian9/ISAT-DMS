                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
                    ...
                    <div className="text-center mb-10">
                        ...
                        <div className="inline-flex items-center justify-center mb-6">
                            <img src="/pictures/isat.jpg" alt="ISAT" className="h-20 w-20 rounded-full object-cover shadow-xl ring-4 ring-green-500/30" />
                        </div>
                        
                        {/* Main Heading */}
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 mb-4 leading-tight">
                            Welcome back, <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 via-green-500 to-green-600 animate-pulse">{user.name.split(' ')[0]}</span>
                        </h1>
                        
                        <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed font-medium mb-4">
